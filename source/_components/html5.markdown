...
vapid_pub_key:
  ...
  type: string
vapid_prv_key:
  description: The VAPID private key generated by Google. (Click on the three dots next to Web Push certificates key pair, and select "show private key". If you can't see the three dots, move your mouse cursor to the generated key pair)
  required: true
  type: string
vapid_email:
